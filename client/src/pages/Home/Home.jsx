  ...
  return (
    <div className='Home'>
      ...
      <div className='about-me'>
          ...
          I am deeply passionate about programming and application development. My experience in this field, extending over five years, was most recently enhanced through a rigorous Software Engineering bootcamp, marking a significant milestone in my continuous pursuit of technical excellence and innovation. This period has been characterized by a combination of personal ventures and professional assignments, each contributing to my comprehensive understanding of software development and technology.          </p><br/>
